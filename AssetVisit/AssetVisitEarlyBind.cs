...
{
    internal class AssetVisitEarlyBind: IPlugin        
    {
        public void Execute(IServiceProvider serviceProvider)
        {
           ...
           // EarlyBL ac = new EarlyBL(service, visiterName, visiterPhone, email, visitTime, assetId, contact, tracingService);
            ...
            EarlyBL earlyBL = new EarlyBL(service, tracingService);
            Guid visitId = earlyBL.CreateAsset( visiterName, visiterPhone, email, visitTime, assetId, contact);
